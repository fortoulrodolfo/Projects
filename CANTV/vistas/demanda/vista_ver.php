...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <article style="margin-bottom:150px;">
        	<form name="form2" method="post" action="ficheroExcel1.php" id="FormularioExportacion1">
            <input type="hidden" id="datos_a_enviar" name="datos_a_enviar"/>
            </form>
            
              
          <form name="form3" method="post" action="ficheroExcel11.php" id="FormularioExportacion3">
        	...
        	<form name="form1" method="post" action="" id="FormularioExportacion">
                ...
                <p class="planilla"><strong>Datos De Servicios</strong></p>
                
				<?php if(($_SESSION['tipo']) == "4"){
					echo " <div id=imagenes_ver' style='margin-left:250px;'>
            		<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel'/> 
            		<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas' onclick='imprimir(4);'/>
					...
					$de->listar_demandas();
						...
						elseif(($_SESSION['tipo']) == "2"){
							echo " <div id=imagenes_ver' style='margin-left:250px;'>
							<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel'/> 
							<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas' onclick='imprimir(2);'/>
							<img src='../../shared/img/img iconos descargas/ICONOS3.png' class='img_descargas2'/>
									</div> ";
							$de->listar_demandas_lider();
						}
							elseif(($_SESSION['tipo']) == "3"){
								echo " <div id=imagenes_ver' style='margin-left:250px;'>
							<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel'/> 
							<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas' onclick='imprimir(3);'/>
							<img src='../../shared/img/img iconos descargas/ICONOS3.png' class='img_descargas2'/>
									</div> ";
								$de->listar_demandas_gerente();
							}
				?>
           	</form>
        </article>
