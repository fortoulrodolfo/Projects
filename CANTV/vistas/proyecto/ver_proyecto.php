...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <title>. : : Listado De Proyecto : : .</title>
         ...
         <script language="javascript">
			$(document).ready(function(){
				...
				$(".img_descargas2").click(function(event){
					$("#datos_a_enviar3").val( $("<div>").append( $("#Exportar_a_Excel2").eq(0).clone()).html());
	...
	<body>
        ...
        <form name="form2" method="post" action="ficheroExcel2.php" id="FormularioExportacion2">
          ...
          <form name="form3" method="post" action="ficheroExcel3.php" id="FormularioExportacion3">
        	...
        	<form name="form1" id="form1" action="" method="post">
                ...
                <p class="planilla"><strong>Datos De Proyectos </strong></p>
               
				<?php if(($_SESSION['tipo']) == "4"){
					echo " <div id=imagenes_ver' style='margin-left:250px;'>
            		<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel'/> 
            		<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas' onclick='imprimir_pro(4);'/>
					...
					$de->listar_proyecto();
						...
						elseif(($_SESSION['tipo']) == "2"){
							echo " <div id=imagenes_ver' style='margin-left:250px;'>
            		<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel'/> 
            		<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas' onclick='imprimir_pro(2);'/>
                	<img src='../../shared/img/img iconos descargas/ICONOS3.png' class='img_descargas2'/>
            	</div> ";
							$de->listar_proyecto_lider();
						}
							elseif(($_SESSION['tipo']) == "3"){
								echo " <div id=imagenes_ver' style='margin-left:250px;'>
            		<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel'/> 
            		<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas' onclick='imprimir_pro(3);'/>
                	<img src='../../shared/img/img iconos descargas/ICONOS3.png' class='img_descargas2'/>
            	</div> ";
								$de->listar_proyecto_gerente();
							}
				?>
           	</form>
        </article>
        
        <table class="tpro" style="width:450px; margin-left:250px;">
        	<tr  class="title">
            	<td>LEYENDA ALERTA</td>
            </tr>
        </table>
           <table class="tpro" style="margin-top:0px; width:450px; margin-bottom:10px; margin-left:250px;">
        	<tr>
            	<td><img src="../../shared/img/img alertas/Bombillo-Blanco.jpg" width="26" height="26">Consultor Sin Actualizar</td>
                <td><img src="../../shared/img/img alertas/Bombillo-Verde.jpg" width="26" height="26">Fase Actualizada</td>
                <td><img src="../../shared/img/img alertas/Bombillo-Amarillo.jpg" width="26" height="26">Misma Fase +1 Mes</td>
                <td><img src="../../shared/img/img alertas/Bombillo-Rojo.jpg" width="26" height="26">Misma Fase +3 Meses</td>
            </tr>
        </table>
