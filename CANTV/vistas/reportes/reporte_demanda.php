...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
       ...
       <p class="planilla">Reportes Demanda</p>
        <article id="portada111" name="portada111">
       
        	<form name="form2" method="post" action="ficheroExcel.php" id="FormularioExportacion1">
          ...
          <form name="form3" method="post" action="ficheroExcel3.php" id="FormularioExportacion3">
        	...
        	<form name="form1" method="post" action="" id="FormularioExportacion">
              ...
              <!--  <div id='imagenes_ver2'>
            		<img src='../../shared/img/img iconos descargas/ICONOS2.png' class='botonExcel2'/> 
            		<img src='../../shared/img/img iconos descargas/ICONOS.png' class='img_descargas2' onclick='imprimir();'/>
                	<img src='../../shared/img/img iconos descargas/ICONOS3.png' class='img_descargas3'/>
            	</div>-->
        	<?php $de->reporte_demanda() ?>
