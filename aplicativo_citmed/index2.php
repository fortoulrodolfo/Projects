...
<?php
	...
	$opcion="Principal";
	$_SESSION["autorizacionOpciones"]="1,1,1,1";
	$_SESSION["nac"]="V";
	$_SESSION["cedula"]="5";
	//chequearUsuario($link);
	//chequearCaducado($link);
	//chequearMedico($userBD, $claveBD, $servicioBD);
		...
		<div id="wrapper">
			...
			<div id="two-columns" style="width:900px; height:125px;">
				...
				<div id="col1" style="width:550px; float:left;">
					<center>
						...
						<font style="font-size:1.1em; color:#646464;">Sistema de Citas</font><br>
			...
			<center>
            	<button id="sesion" type="button" class="link-style" style="width:170px;"
						onClick="window.location='<?php echo $link; ?>citmed/index.php'">
					Inicio
				</button>
				<button id="sesion" type="button" class="link-style" style="width:170px;"
						onClick="window.location='<?php echo $link; ?>citmed/sesion/cierreSesion.php'">
					Cerrar Sesión
				</button><br><br><br>
			</center>
			...
			<center>
            	<?php
				indicarOperacionesUED($link,$opcion);
				?>
			</center>
