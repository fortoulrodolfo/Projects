...
<html>
	...
	<body onLoad="goforit();">
		<div id="wrapper">
			<br>
			<div id="two-columns" style="width:950px; height:125px;">
				...
				<div id="col1" style="width:550px; float:left;">
					<center>
						...
						<font style="font-size:1.1em; color:#646464;">Libro de Citas Bitacora</font><br>
			...
			<center>
             ...
             <center>
              		...
              		<font size="5" id="titulo" style="color:#646464;">Consulta de Citas Bitacora</font><br><br><br>
				...
				<center>
					<!-- Botón de búsqueda y limpiar.
					  -->
					<input type="button" value="Buscar" onClick="cargarCitasBitacora();" class="link-style"/>
					<button id="limpiar" type="button" onClick="limpiarLibroBitacora();" class="link-style">Limpiar</button>
				</center>
                ...
                <center>
                	<div align="right" style="width:850px; margin-bottom:10px; margin-top:-30px;">
                            ...
                            onClick ="cargarLibroPDFBitacora();">PDF</a>
                            <a id="xls" class="front" style="opacity:0.0; cursor:pointer; visibility:hidden;" onClick ="cargarLibroExcelBitacora();">XLS</a>
                    </div>	
                	<div id="menuA" style="width:920px; height:500px; overflow-y: auto;">
                    	 <table id="tabla_citas" style="width:100%; overflow-y: auto; color:#646464; font-size:11px" >
