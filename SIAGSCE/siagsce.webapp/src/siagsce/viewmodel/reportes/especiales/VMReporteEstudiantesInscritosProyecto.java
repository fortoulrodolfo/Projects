...
/**
 * ViewModel para la vista del reporte de  Consulta de Estudiantes Incritos por Proyecto,
 * Filtrado por Dirección de Programa, Proyecto.
 * @author Iterator
 */
@VariableResolver(org.zkoss.zkplus.spring.DelegatingVariableResolver.class)
public class VMReporteEstudiantesInscritosProyecto {
	...
	private String ruta="/WEB-INF/siagsce/reportes/especiales/ReporteEstudiantesIncritosProyecto.jasper";
	...
	/**
	 * Método que inicializa los modelos y carga el programa 
	 * desde la BD y el combos de programas
	...
	public void llenarListaDinamica() {
		...
		String condicion=" where e.estudiante_cedula = pro.estudiante_cedula AND pro.preinscripcion_proyecto_codigo = inp.preinscripcion_proyecto_codigo ";
		/**
		...
		if(selectedProyecto!=null){
			condicion=condicion+" and inp.proyecto_codigo  ="+ "'"+selectedProyecto.getProyectoCodigo()+"'"+" and pp.proyecto_codigo  ="+ "'"+selectedProyecto.getProyectoCodigo()+"'";
			desbloquear();
		}

		
		/**
		 * Guarda la Selección que haga el usuario en fechaIncio y fechaFin
		 **/
		if(selectedProyecto!=null && fechaInicio!=null && fechaFin!=null)
		{
			if(fechaFin.after(fechaInicio)){
				condicion=condicion+" and inp.inscripcion_proyecto_fecha BETWEEN "+"'"+fechaInicio+"'"+" and "+"'"+fechaFin+"'";
				desbloquear();
			}
			else
			{
		...
		listestudiante = sListadoEstudiantesDireccionPrograma.buscarEstudiantesDireccionProgramaProyectoDinamico(condicion);
	...
	**/
	...
	public void filtrarEstudianteInscritos() {
		try {
