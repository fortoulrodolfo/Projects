 ...
 * por el segundo arbol de opciones en registrar grupo
 * (arbol que contiene las opciones que van hacer almacenadas en el grupo).
 * @author Iterator
 */
public class VMContactTreeRenderer2 implements TreeitemRenderer<VMContactTreeNode> {
	/**
	...
	public void render(final Treeitem treeItem, VMContactTreeNode treeNode, int index) throws Exception {
		...
		treeItem.setOpen(ctn.isOpen());
			Hlayout hl = new Hlayout();hl.appendChild(new Label(contact.getNombrefuncion()));
