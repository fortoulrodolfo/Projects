...
public class VMCatalogoDireccionProgramas {
	...
	private Set<DireccionPrograma> selectedDireccionPrograma;
	...
	public Set<DireccionPrograma> getSelectedDireccionPrograma() {
		return selectedDireccionPrograma;
	}

	public void setSelectedDireccionPrograma(
			Set<DireccionPrograma> selectedDireccionPrograma) {
	...
	public void init(@ContextParam(ContextType.VIEW) Component view,
		...
		modeloDireccionPrograma.setMultiple(true);
	}
	...
	**/
	...
	public void aceptar() {
		...
		if (selectedDireccionPrograma != null) {
			...
			listdireccion.addAll(selectedDireccionPrograma);
